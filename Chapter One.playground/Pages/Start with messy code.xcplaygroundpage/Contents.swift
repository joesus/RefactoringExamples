/*:
 ### Starting with the Statement Method

 The statement method has issues. It is too large and difficult to extend.
 It relies on the Movie and Rental classes in the sources directory.
